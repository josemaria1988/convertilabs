...
export const buttonSecondaryChromeClassName =
  "ui-button--secondary border-[color:var(--color-border)] bg-[color:var(--color-surface)] text-[color:var(--color-foreground)] hover:border-[color:var(--color-accent)] hover:bg-[color:var(--color-accent-soft)]";

export const buttonMutedChromeClassName =
  "border-dashed border-[color:var(--color-border)] bg-transparent text-[color:var(--color-muted)]";
