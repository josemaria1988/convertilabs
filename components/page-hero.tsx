...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden rounded-[8px] border border-[color:var(--color-border)] bg-[linear-gradient(135deg,rgba(19,24,31,0.98),rgba(31,29,26,0.94))] text-white shadow-[0_28px_100px_rgba(15,23,42,0.18)]">
