...
export function parseDraftFacts(fieldsJson: JsonRecord | null): DocumentIntakeFactMap {
  ...
  return {
    ...
    issuer_address_raw: asString(facts.issuer_address_raw),
    issuer_department: asString(facts.issuer_department),
    issuer_city: asString(facts.issuer_city),
    issuer_branch_code: asString(facts.issuer_branch_code),
    merchant_category_hints: asStringArray(facts.merchant_category_hints),
    location_extraction_confidence: asNumber(facts.location_extraction_confidence),
