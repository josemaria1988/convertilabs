...
create policy "organization_members_select_self_or_owner_admin"
...
create policy "organization_members_insert_owner_admin_or_bootstrap"
on public.organization_members
for insert
with check (
  public.has_org_role(
  ...
  or public.can_bootstrap_org_owner(organization_id, user_id, role)
);
