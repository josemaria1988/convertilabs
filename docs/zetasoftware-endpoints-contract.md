> **Estado Convertilabs 2.0:** contrato tecnico vigente para endpoints Zeta. Queda subordinado a `docs/convertilabs-2.0-baseline-arquitectura.md`, `docs/analisis-arquitectura-convertilabs-2.0.md`, `docs/plan_de_accion_convertilabs2_PRs_analisis.md` y `docs/agent_rules.md`.
