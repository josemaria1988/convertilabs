-- Repair missing internal operations schema from canonical definitions.
-- Creates empty tenant-scoped tables, indexes and RLS only. No backfills or ERP writes.
-- The historical PR12 migration remains unchanged; its profile_id policies are superseded here.

-- Canonical source: db/schema/12_operations_communications.sql
...
-- Canonical source: db/schema/13_operational_intelligence.sql
...
-- Canonical source: db/schema/15_work_intake.sql
